...
class SeleniumTest(unittest.TestCase):
    ...
    def test_generate(self):
        ...
        DRIVER.get(URL_APP+"/diploma?diplomaGenerar=wasd&nombreDiploma=prueba&name=Alejandro&course=Comité%20de%20Programa&score=2&date=2020-02-02&mailto=fernandoclarosb@gmail.com")
    ...
    def test_generate_error_nombre(self):
        ...
        DRIVER.get(URL_APP+"/diploma?diplomaGenerar=wasd&nombreDiploma=prueba1&name=Alejandro%20Ruiz&course=Comité%20de%20Programa&score=2&date=2020-02-02&mailto=xnegis@gmail.com")

        self.assertTrue("Nombre: " in DRIVER.find_element_by_tag_name('pre').text)

    def test_generate_error_nombre_vacio(self):

        DRIVER.get(URL_APP+"/diploma?diplomaGenerar=wasd&nombreDiploma=prueba1&name=&course=Comité%20de%20Programa&score=2&date=2020-02-02&mailto=xnegis@gmail.com")

        self.assertTrue("Nombre: " in DRIVER.find_element_by_tag_name('pre').text)

    def test_generate_error_diploma_generar_vacio(self):

        DRIVER.get(URL_APP+"/diploma?diplomaGenerar=&nombreDiploma=holaprueba1&name=Alejandro&course=Comité%20de%20Programa&score=2&date=2020-02-02&mailto=xnegis@gmail.com")
